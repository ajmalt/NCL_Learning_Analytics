...
```
* *detected_country*, giving (I assume) the country the system detects the user in when taking the course (or "--" for unknown). *N.B. attempting to preview the levels in this field results in an error: "pandoc document conversion failed with error 11". Given time contraints, the list of countries is not previewed here. *
